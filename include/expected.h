...
namespace detail {
    ...
    namespace swap_adl_tests {
        ...
        std::
            is_same<decltype(swap(std::declval<T&>(), std::declval<U&>())), tag>
            uses_std(int);
    ...
    struct is_swappable<T[N], T[N]>:
        std::integral_constant<
            ...
            decltype(detail::swap_adl_tests::can_swap<T[N], T[N]>(0))::value
                && (!decltype(detail::swap_adl_tests::uses_std<T[N], T[N]>(0)
                    )::value
        ...
        std::integral_constant<
            ...
            is_swappable<T, U>::value
                && ((decltype(detail::swap_adl_tests::uses_std<T, U>(0))::value
                    ...
                    || (!decltype(detail::swap_adl_tests::uses_std<T, U>(0)
                        )::value
...
//no constexpr for GCC 4/5 bug
    ...
    template<
        ...
        class E,
        bool =
            is_void_or<T, TL_EXPECTED_IS_TRIVIALLY_COPY_CONSTRUCTIBLE(T)>::value
...
// move assignable
    ...
    struct expected_default_ctor_base {
        ...
        constexpr expected_default_ctor_base(expected_default_ctor_base const&) noexcept =
            default;
...
namespace detail {
    ...
    constexpr auto expected_map_impl(Exp&& exp, F&& f) {
        ...
        return exp.has_value()
            ? result(detail::invoke(std::forward<F>(f), *std::forward<Exp>(exp))
              )
